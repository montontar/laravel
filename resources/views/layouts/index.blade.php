      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{url('/contact')}}">
            ...
            <span class="nav-link-text ms-1">Data Table</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Social</h6>
          <a class="nav-link " href="{{url('/newfeed')}}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">New Feed</span>
          </a>
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{url('/friendlist')}}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-credit-card text-success text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Friend List</span>
          </a>
        </li>
...
<main class="main-content position-relative border-radius-lg ">
    <!-- <div class="card mt-4 col-11 ml-5 ">
        <div class="card-header border-radius-lg">
            <img src="../assets/img/1.jpg" class="border-radius-lg  img-responsive ml-4" style="display: cover; max-width: 100%; max-height: 40%;">
        </div>
    </div> -->
